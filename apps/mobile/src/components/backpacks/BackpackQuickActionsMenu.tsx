...
import { measureQuickActionsMenuLeft } from "../documents/DocumentQuickActionsMenu";

export interface BackpackQuickActionsMenuProps {
  visible: boolean;
  top: number;
  left: number;
  onClose: () => void;
...
export function BackpackQuickActionsMenu({
  visible,
  top,
  left,
  onClose,
...
export function measureBackpackQuickActionsMenuLeft(anchorX: number, anchorWidth: number): number {
  return measureQuickActionsMenuLeft(anchorX, anchorWidth);
}
