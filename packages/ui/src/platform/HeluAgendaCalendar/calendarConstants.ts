...
/** Navigation step per view mode (day / 3-day / week only; month uses addMonths). */
...
/** Adjacent months included when fetching month view (prev + current + next). */
export const MONTH_BUFFER_MONTHS = 1;
